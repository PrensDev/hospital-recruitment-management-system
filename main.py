...
# Import Routers
from routers.api import test_apiRoute, auth_apiRoute, deptMngr_apiRoute, deptHead_apiRoute, hireMng_apiRoute, recruiter_apiRoute, home_apiRoute
from routers.web import home_webRoute, deptMngr_webRoute, deptHead_webRoute, hireMng_webRoute, recruiter_webRoute
