            ...
            if not applicant.first():
                ...
                # Rejected from Evaluation
                    ...
                    messageBody = f"""
                        ...
                        <p>Thank you for your time on the application. Our hiring team reviewed your application but we regret to notify you that you were not chosen for further consideration. Because the competition was fierce, we decided to take a different path. Thank you for your interest in our firm, and we wish you the best of luck in your future endeavors</p>
