        ...
        if(authorized(user_data, AUTHORIZED_USER)):
            ...
            for a in req.interviewees:
                ...
                messageBody = f"""
                    ...
                    <h3>This is from HoMIES.</h3>

                    <p>We would like to inform you that you have a job interview on <b>{scheduled_date}</b>, from <b>{start_session}</b> to <b>{end_session}</b>. We are hoping to see you there! For some updates, please check your email regularly.</p>
                    <p>Thank you!</p>
